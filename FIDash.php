...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Faculty Intern') {
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="nav-menu">
                <a href="FIDash.php" class="nav-item active">
                    <span class="nav-icon">🏠</span>
                    Dashboard
                </a>
                <a href="FIcourses.php" class="nav-item active">
                    <span class="nav-icon">📖</span>
                    My Courses
                </a>
                <a href="FISessions.php" class="nav-item active">
                    <span class="nav-icon">📊</span>
                    Sessions
                </a>
                
                <a href="FIReports.html" class="nav-item active">
                    <span class="nav-icon">📊</span>
                    Grade report 
                </a>
            </nav>
        ...
        <div class="main-content">
            ...
            <p>An overview of your activities</p>
            ...
            <div class="cards-grid">
                <div class="card">
                    ...
                    <h3>My courses</h3>
                    <p>Manage courses materials</p>
                    <a href="FIcourses.php" class="card-button">view course</a>
            </div>
            ...
            <div class="card">
                    ...
                    <a href="FISessions.php" class="card-button">view sessions</a>
            </div>
            ...
            <div class="card">
                    ...
                    <a href="FIReports.html" class="card-button">view grade</a>
            </div>
