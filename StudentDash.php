    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav c;ass="nav-menu">
                ...
                <a href="StudentSessions.php" class="nav-item active">
                    <span class="nav-icon">📊</span>
                    Sessions
                </a>
                
                <a href="StudentReport.html" class="nav-item active">
                    <span class="nav-icon">📊</span>
                    Grade report
                </a>
            </nav>
        ...
        <div class="main-content">
            ...
            <div class="cards-grid">
                <div class="card">
                    ...
                    <h3>My courses</h3>
                    <p> Access all your course</p>
                    <a href="my_courses.php" class="card-button">view course</a>
            </div>

            <div class="card">
                    <div class="card-icon sessions">📚</div>
                    <h3>Sessions</h3>
                    <p> Ceck your upcoming class</p>
                    <a href="StudentSessions.php" class="card-button">view sessions</a>
            </div>
            ...
            <div class="card">
                    ...
                    <h3>Grades</h3>
                    <p> See your grades</p>
                    <a href="StudentReport.html" class="card-button">view grade</a>
            </div>
